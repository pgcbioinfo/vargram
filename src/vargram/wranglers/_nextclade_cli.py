...
def create_command(**kwargs):
    ...
    Args:
        input (dict): Dictionary containing the user input to nextread().
        secure_analysis_dir (string): Secure temporary directory to store Nexclade analysis TSV output.
        secure_ref_dir (string): Secure temporary directory to store reference sequence from Nextclade.

    Returns:
        list: A list whose elements constitute the Nextclade command.
    """
...
def capture_output(command):
    ...
    Args:
        command (string): The Nextclade CLI command.
